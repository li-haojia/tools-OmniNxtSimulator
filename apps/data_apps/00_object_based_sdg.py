...
import data_apps.synthetic_data.object_based_sdg_utils as object_based_sdg_utils
...
for obj in labeled_assets_and_properties:
    ...
    print("scale_min_max: ", scale_min_max)
    for i in range(count):
        ...
        asset_path = obj_url if obj_url.startswith("omniverse://") or obj_url.startswith("file://") else assets_root_path + obj_url
