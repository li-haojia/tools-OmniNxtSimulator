...
$SCRIPT_DIR/../isaaclab.sh -p $TARGET_SCRIPT $SCRIPT_ARGS --headless --livestream 2 --kit_args "--enable isaacsim.ros2.bridge --enable omni.kit.livestream.webrtc --enable isaacsim.asset.gen.omap"